      ...
      <div class="col-xl-12 col-lg-7">
             <div class="card shadow mb-4 mt-3">
              <!-- Card Header Dropdown -->
               ...
               <!-- Card Body -->
               <div class="card-body">
               <form class="form-validate form-horizontal" id="produk_form" method="POST" enctype="multipart/form-data"
                action="{{ url('store') }}">
                {!! csrf_field() !!} 
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                       <label for="curl" class="control-label col-lg-2">Berat Isi Produk <span class="required">*</span></label>
                        <div class="col-lg-10">
                        <input type="number" class="form-control" id="beratisi_produk" name="beratisi_produk" value="{{ old('beratisi_produk') }}">
                      ...
                      <div class="form-group">
                        <label for="curl" class="control-label col-lg-2">Harga Produk <span class="required">*</span></label>
                          <div class="col-lg-10">
                          <input type="number" class="form-control" id="harga_produk" name="harga_produk" value="{{ old('harga_produk') }}">
